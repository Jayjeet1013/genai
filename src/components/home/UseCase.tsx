...
const UseCase = () => {
  return (
   <Box bg={'#1a1d24'} pb={24}>
        ...
        <Box textColor={'white'}>
          <Center>
                <Box textAlign={'center'} p={{base:2,md:4}} maxWidth={{ base: '100%', md: '900px' }}>
                        <Text p={{base:2,md:4}}   textColor={'yellow'}>GenAI Use Cases</Text>
                        <Text fontWeight={'bold'} fontSize={{base:'36px',md:'44px'}} p={{base:2,md:4}}   >Write Better Content Faster, The Future Of AI Writing Tools is Here
</Text>
                </Box>
</Center>
